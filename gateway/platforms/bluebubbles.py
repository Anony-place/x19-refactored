...
# `require_mention: true` without custom aliases uses X19 wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?x19\s+agent\b[,:\-]?", r"(?<![\w@])@?x19\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (X19 defaults)."""
