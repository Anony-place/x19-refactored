...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your X19 session"),
        ...
        _cmd("status", "Show X19 session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running X19"),
        ...
        _cmd("update", "Update X19 to the latest version"),
        _cmd("restart", "Gracefully restart the X19 gateway"),
