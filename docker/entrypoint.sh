...
# by /etc/cont-init.d/01-x19-setup (installed by the Dockerfile). This
...
# on the pre-s6 contract "entrypoint.sh sets up state then execs x19"
...
echo "[x19] WARNING: docker/entrypoint.sh is a deprecated shim under " \
