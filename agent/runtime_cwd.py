...
_SESSION_CWD: ContextVar = ContextVar("X19_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the X19 source tree, a
    legitimate workspace when developing X19; fallback-directory policy lives in the caller."""
