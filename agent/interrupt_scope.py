...
A host that runs a blocking command on a worker thread (X19 Console) never sees
...
_ACTIVE_SCOPE: ContextVar[Optional["InterruptScope"]] = ContextVar("x19_interrupt_scope", default=None)
