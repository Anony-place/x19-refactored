...
The learned value is kept per ``model@host`` in ``~/.x19/cache/image_token_costs.json`` so a new
...
_image_cost_var: ContextVar[Optional[int]] = ContextVar("x19_image_token_cost", default=None)
