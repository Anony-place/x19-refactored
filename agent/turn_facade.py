...
class TurnFacadeMixin:
    ...
    def run_conversation(
        ...
        from x19_cli.observability.relay_shared_metrics import finish_task_run, start_task_run
        ...
        try:
            ...
            # A host that owns this thread (X19 Console) may cancel the turn cross-thread.
