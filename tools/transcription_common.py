...
LOCAL_STT_COMMAND_ENV = "X19_LOCAL_STT_COMMAND"
LOCAL_STT_LANGUAGE_ENV = "X19_LOCAL_STT_LANGUAGE"
...
# DeepInfra STT base URL is resolved via x19_cli.models.deepinfra_base_url (shared).
