...
_HOMEBREW_CI_POLLER_HINT = (
    ...
    'and/or `gh pr checks | jq`. That shape has burned us repeatedly in x19 dev work '
    ...
    "skill_view(name='github/x19-dev', file_path='references/green-ci-policy.md') for "
...
_ASYNC_UNSUPPORTED_NOTE = (
    ...
    'an async completion after the turn ends (a one-shot runner such as `x19 -z`, a cron '
...
# proc_session attribute -> X19_SESSION_* env var carrying it.
_ROUTING_FIELDS = (
    ("watcher_chat_id", "X19_SESSION_CHAT_ID"),
    ("watcher_user_id", "X19_SESSION_USER_ID"),
    ("watcher_user_name", "X19_SESSION_USER_NAME"),
    ("watcher_thread_id", "X19_SESSION_THREAD_ID"),
    ("watcher_message_id", "X19_SESSION_MESSAGE_ID"),
    ...
    ("parent_session_id", "X19_SESSION_ID"),
)
