...
started by `x19 mcp login/reauth`, never a background reconnect.
"""
...
async def login_device(name, server_url, oauth_config):
    ...
    from tools.mcp_oauth_manager import X19MCPOAuthProvider, get_manager
    ...
    provider = X19MCPOAuthProvider(server_url=server_url, server_name=name, storage=storage,
