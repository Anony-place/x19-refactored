...
DIALOG_BRIDGE_HOST = "x19-dialog-bridge.invalid"
...
(() => {
  if (window.__x19DialogBridgeInstalled) return;
  window.__x19DialogBridgeInstalled = true;
  const ENDPOINT = "http://x19-dialog-bridge.invalid/";
