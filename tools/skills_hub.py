...
Used by x19_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
_skills_dir = _path_resolver("SKILLS_DIR", "X19_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"X19_HOME": _x19_home, **{
