"""Skills configuration for X19. `x19 skills` enters this module."""
from typing import List, Optional, Set

from x19_cli.config import cfg_get, load_config, save_config
from x19_cli.colors import Colors, color
from x19_cli.platforms import PLATFORMS as _PLATFORMS
...
def save_disabled_skills(config: dict, disabled: Set[str], platform: Optional[str] = None):
    """Persist disabled skill names to config; essential skills (e.g. ``x19``) are
