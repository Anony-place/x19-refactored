"""Non-interactive HTTPS credentials for X19's internal git clones (private plugin/MCP/profile repos).
...
repo the user can already clone from their shell fails inside ``x19 plugins install`` with
