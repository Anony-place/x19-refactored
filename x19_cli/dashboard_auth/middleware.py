...
from x19_cli.dashboard_auth import list_session_providers
from x19_cli.dashboard_auth.audit import AuditEvent, audit_log
from x19_cli.dashboard_auth.base import ProviderError
...
from x19_cli.dashboard_auth.prefix import prefix_from_request
from x19_cli.dashboard_auth.public_paths import PUBLIC_API_PATHS
...
def _safe_next_target(request: Request) -> str:
    ...
    SPA's ``sessionStorage["x19.lastLocation"]``."""
