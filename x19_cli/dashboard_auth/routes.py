...
from x19_cli.dashboard_auth import prefix as _prefix_mod
...
from x19_cli.dashboard_auth.cookies import (
    ...
    set_session_cookies)
from x19_cli.dashboard_auth.login_page import (
    render_login_html, render_native_provider_choice_html)
from x19_cli.dashboard_auth.refresh_singleflight import refresh_session_coalesced
from x19_cli.dashboard_auth.request_utils import (
...
def _provider_pkce_segments(cookie_payload: dict[str, str]) -> dict[str, str]:
    ...
    flat = cookie_payload.get("x19_session_pkce", "")
...
async def api_auth_ws_ticket(request: Request):
    ...
    sess = _require_session(request)
    from x19_cli.dashboard_auth.ws_tickets import TTL_SECONDS, mint_ticket
