...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures X19 to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  X19 needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the X19 gateway in another terminal:",
        "         x19 gateway", "",
    ...
    _lines(
        ...
        "  Docs: https://anony-place.github.io/x19-refactored/docs/user-guide/",
