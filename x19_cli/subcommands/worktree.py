"""``x19 worktree`` subcommand parser."""
...
def build_worktree_parser(subparsers) -> None:
    ...
    worktree_parser = subparsers.add_parser(
        ...
        description="Attended reclaim for the .worktrees/ directory x19 -w sessions "
            "accumulate. Never deletes uncommitted tracked changes, unique "
            "unpushed commits, or in-use trees; untracked-only scratch is "
            "archived to ~/.x19/archive/worktree-prune/ before removal. See: "
            "https://anony-place.github.io/x19-refactored/docs/user-guide/cli#worktree-cleanup")
