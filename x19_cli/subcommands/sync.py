"""``x19 sync`` subcommand parser — Skill Sync.
...
def build_sync_parser(subparsers, *, cmd_sync: Callable) -> None:
    ...
    sync_parser = subparsers.add_parser(
        ...
        epilog="Examples:\n"
            "  x19 sync status            what is synced, and from where\n"
            "  x19 sync enable my-skill   include a skill in your sync\n"
            "  x19 sync now               pull, then push\n"
            "  x19 sync propose my-skill  share a skill with your team\n",
