...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the X19 Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any x19 CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--x19-root",
        help="Override the X19 source root used by Desktop (sets X19_DESKTOP_X19_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets X19_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="X19 Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: X19 Local Signing)",
    )
