...
def build_secrets_parser(subparsers) -> None:
    ...
    secrets_parser = subparsers.add_parser(
        ...
        description="Pull API keys from an external secret manager at process startup "
            "instead of storing them in ~/.x19/.env.  Supports Bitwarden "
            "Secrets Manager and 1Password.  See: "
            "https://anony-place.github.io/x19-refactored/docs/user-guide/secrets/")
    ...
    from x19_cli import secrets_cli as _secrets_cli
    from x19_cli import onepassword_secrets_cli as _op_secrets_cli
