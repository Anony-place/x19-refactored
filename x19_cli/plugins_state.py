"""Plugin-owned durable state and namespaced settings helpers (split out of x19_cli.plugins)."""
...
from x19_cli.plugins_manifest import _portable_skill_namespace
...
class PluginState:
    ...
    def data_dir(self) -> Path:
        ...
        return get_x19_home() / "plugin-data" / self._data_namespace
