"""X19 middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "x19.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "x19.middleware.v1"
...
def _apply_request_chain(
    ...
    from x19_cli.plugins import invoke_middleware
...
def apply_llm_request_middleware(request: Dict[str, Any], **context: Any) -> RequestMiddlewareResult:
    ...
    from x19_cli.plugins import has_middleware
