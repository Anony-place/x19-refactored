...
def _resolved_https_context() -> ssl.SSLContext | None:
    """Return the explicit CA context for X19-owned urllib openers."""
...
def _secure_opener_from_installed_policy(original_url: str, *, ssl_context=None):
    ...
    secured._x19_initial_addheaders = list(getattr(installed, "addheaders", ()))
    secured.addheaders = []
    return secured
...
def open_credentialed_url(
    ...
    *,
    ...
    if opener_factory is None:
        ...
        for name, value in getattr(opener, "_x19_initial_addheaders", ()):
