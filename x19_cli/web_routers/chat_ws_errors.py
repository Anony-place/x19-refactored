...
``x19 --tui`` child cannot be spawned. The exception text alone is either
...
CHAT_NEEDS_NODE = (
    "Chat could not start: X19 needs Node.js to run the terminal chat. "
...
CHAT_START_FAILED = "Chat could not start: {detail} Check the server log (`x19 dashboard` terminal) and click Start new session."
