...
from x19_cli.local_runtime.binaries import server_binary, runtimes_root
from x19_cli.local_runtime.processes import spawn_server
...
def state_path() -> Path:
    """Endpoint state for other X19 processes (provider resolution routes llamacpp-alias
