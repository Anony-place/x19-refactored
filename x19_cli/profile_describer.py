...
Mirrors ``x19_cli/kanban_specify.py``: lazy aux client import, lenient response parse,
...
_SYSTEM_PROMPT = """You are a profile-describer for the X19 kanban board.
...
Rules:
  ...
  - Never write "X19 profile" or other meta-narration.
...
def _extract_json_blob(raw: str) -> Optional[dict]:
    from x19_cli.kanban_specify import _extract_json_blob as _extract
