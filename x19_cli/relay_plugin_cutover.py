"""Shared migration guards for X19' native NeMo Relay ownership."""
...
RELAY_PLUGINS_CONFIG_ENV = "X19_NEMO_RELAY_PLUGINS_TOML"

LEGACY_RELAY_PLUGIN_KEYS = frozenset({"nemo_relay", "observability/nemo_relay"})

LEGACY_RELAY_EXPORT_ENV_VARS = frozenset({
    "X19_NEMO_RELAY_ATOF_ENABLED",
    "X19_NEMO_RELAY_ATOF_OUTPUT_DIRECTORY",
    "X19_NEMO_RELAY_ATOF_FILENAME",
    "X19_NEMO_RELAY_ATOF_MODE",
    "X19_NEMO_RELAY_ATIF_ENABLED",
    "X19_NEMO_RELAY_ATIF_OUTPUT_DIRECTORY",
    "X19_NEMO_RELAY_ATIF_FILENAME_TEMPLATE",
    "X19_NEMO_RELAY_ATIF_AGENT_NAME",
    "X19_NEMO_RELAY_ATIF_AGENT_VERSION",
    "X19_NEMO_RELAY_ATIF_EXPORT_TIMEOUT_S",
    "X19_NEMO_RELAY_ATIF_MODEL_NAME",
    "X19_NEMO_RELAY_ATIF_SUBAGENT_EXPORT_MODE",
})
