 ...
 *
 * Each entry is a key/value pair that lands in the packaged X19.app's
 ...
 * "X19 wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("X19 wants to access Music" when X19 never touches the Music
