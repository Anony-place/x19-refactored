# nix/overlays.nix — Expose pkgs.x19 for external NixOS configs
#
...
# `pkgs.x19`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    x19 = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
