      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via X19_BUNDLED_SKILLS /
            # X19_OPTIONAL_SKILLS (see x19.nix), not via the
            ...
            # __init__.py) shipped via symlinks + X19_BUNDLED_LOCALES
            # / X19_OPTIONAL_MCPS, not via the wheel. Excluding them
