...
import { JSON_RPC_METHOD_NOT_FOUND, type ServerRequest } from '@x19/shared/json-rpc-channel'
...
export function useMainApp(gw: GatewayClient) {
  ...
  // "X19 stopped and could not be restarted" is said once per outage; reset on gateway.ready.
  ...
  const cwd = ui.info?.cwd || process.env.X19_CWD || process.cwd()
