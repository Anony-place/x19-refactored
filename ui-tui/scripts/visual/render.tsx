 ...
 * across theme x background scenes to <tmpdir>/x19-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@x19/ink'
...
// The regenerated slate light_colors block from x19_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/x19',
...
const setup = (bgHex: string) => {
  process.env.X19_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
