...
await build({
  ...
  // Skip the prebuilt @x19/ink bundle and inline the source instead:
  ...
  alias: { '@x19/ink': resolve(root, 'packages/x19-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The x19_cli launcher
