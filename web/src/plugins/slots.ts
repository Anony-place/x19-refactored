 ...
 * `window.__X19_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the X19 brand in the top bar
 ...
 *  `window.__X19_PLUGINS__.registerSlot(...)`.
 *
