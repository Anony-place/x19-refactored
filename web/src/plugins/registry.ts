 ...
 *
 * Plugins call window.__X19_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__X19_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__X19_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__X19_PLUGIN_SDK__ = {
    ...
    // window.__X19_SESSION_TOKEN__ directly.
    authedFetch,
