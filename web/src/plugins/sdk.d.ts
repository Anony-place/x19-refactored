/**
 * X19 Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__X19_PLUGIN_SDK__`` and
 * ``window.__X19_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__X19_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``X19PluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@x19/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__X19_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__X19_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__X19_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface X19PluginSDK {
...
declare global {
  interface Window {
    __X19_PLUGIN_SDK__?: X19PluginSDK;
    __X19_PLUGINS__?: PluginRegistry;
  }
}
