import { parseColor, THEME_PRESET_PALETTES, type ThemePresetPalette } from "@x19/shared";
 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `x19_cli/web_server.py`.
 *
 * Presets that also ship on the desktop (midnight, ember, mono, cyberpunk)
 * take their colours from `@x19/shared` `THEME_PRESET_PALETTES` so both
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "X19 Teal",
  description: "Classic dark teal — the canonical X19 look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "X19 Teal (Large)",
  description: "X19 Teal with bigger fonts and roomier spacing",
