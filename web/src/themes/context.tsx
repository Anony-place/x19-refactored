...
const STORAGE_KEY = "x19-dashboard-theme";
...
const FONT_STORAGE_KEY = "x19-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `x19_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "x19-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-x19-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-x19-theme-font", "true");
