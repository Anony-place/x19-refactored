import { applyDocumentLocale, LOCALE_ENDONYMS } from "@x19/shared/i18n";
...
// Display metadata for the language picker — endonyms from @x19/shared so the
