...
Built for [X19](https://github.com/Anony-place/x19-refactored). Usable in any coding agent. Canonical source lives here; synced to [`Anony-place/x19-refactored/skills/creative/ascii-video`](https://github.com/Anony-place/x19-refactored/tree/main/skills/creative/ascii-video) via PR.
