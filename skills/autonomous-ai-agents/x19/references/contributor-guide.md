...
For occasional contributors and PR authors. Full developer docs: https://x19.nousresearch.com/docs/developer-guide/
...
- Use `get_hermes_home()` from `x19_constants` for all paths (profile-safe)
