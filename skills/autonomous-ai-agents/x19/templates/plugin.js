/**
 * X19 desktop plugin template. Save as:
 *   <x19 home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <x19 home> is ~/.x19 by default, or ~/.x19/profiles/<name>
 * when running a named profile (`x19 -p <name>`). Run `x19 doctor` (or
 ...
 * Only these imports resolve: @x19/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@x19/plugin-sdk'
