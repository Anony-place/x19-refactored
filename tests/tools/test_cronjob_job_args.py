...
hardcoded "~/.x19/scripts/" in its messages even though resolution goes
through get_x19_home(), which is per-profile.
"""
...
class TestValidateCronScriptPath:
    ...
    def test_missing_file_error_names_the_resolved_scripts_dir(self):
        ...
        # under profiles, where get_x19_home() is not the global ~/.x19.
        scripts_dir = get_x19_home() / "scripts"
