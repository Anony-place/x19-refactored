...
apps/desktop/src/plugins/x19-bots/canonical-chat-registry.test.ts; here we pin the DB/RPC algebra
...
def home(tmp_path, monkeypatch):
    """Temp X19_HOME so the gateway resolvers read a throwaway state.db.
