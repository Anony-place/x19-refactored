...
part of the bundled-plugins set; a stock x19 install does not see
an "Example" tab in its sidebar. The ``_install_example_plugin`` pytest
fixture in ``tests/x19_cli/test_web_server.py`` copies this directory
into ``$X19_HOME/plugins/example-dashboard/`` and forces the dashboard
