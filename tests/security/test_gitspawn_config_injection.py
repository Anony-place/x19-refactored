...
``[diff "x"] command=/textconv=`` driver. X19 gathers workspace context by
...
context-gathering git path X19 runs neutralizes every sink. They use a real
