...
Damien's incident (Discord, 2026-05-28): a long X19 session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``x19_state`` module, whose ``SessionDB``
...
_NominalSessionDBImpostor.__module__ = "x19_state"
