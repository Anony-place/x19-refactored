...
thinking phase.  X19's default cloud-stream stale detector
(``X19_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``X19_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
