...
class TestKimiEffortVocabulary:
    def test_k3_maps_full_x19_ladder(self):
        expected = {
            "minimal": "low",
            "low": "low",
            "medium": "high",
        ...
        for x19_level, wire_level in expected.items():
            kw = _kimi_kwargs(
                "kimi-k3", {"enabled": True, "effort": x19_level}
            )
            assert kw["reasoning_effort"] == wire_level, x19_level
