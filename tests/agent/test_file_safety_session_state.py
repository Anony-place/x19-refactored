...
manipulation. X19 keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point X19_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_x19_home /
    get_default_x19_root) instead of monkeypatching private helpers —
    ...
    X19_HOME=<root>/profiles/<name> makes get_default_x19_root()
