...
to a generic "Your API key was rejected... run x19 setup" message, which is
...
def test_nous_401_guidance_strings_present():
    ...
    # Must give a concrete re-auth command, not a generic "x19 setup".
    assert "x19 portal" in source
