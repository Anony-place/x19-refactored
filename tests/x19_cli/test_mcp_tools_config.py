"""Tests for MCP tools interactive configuration in x19_cli.tools_config."""

from unittest.mock import patch

from x19_cli.tools_config import _configure_mcp_tools_interactive
...
_CHECKLIST = "x19_cli.curses_ui.curses_checklist"
_SAVE = "x19_cli.tools_config.save_config"
...
def test_disabling_tool_writes_include_list(capsys):
    ...
    catalog flow, `x19 mcp configure`, and this UI all write the same
