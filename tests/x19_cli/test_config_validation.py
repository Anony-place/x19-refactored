...
class TestTimezoneValidation:
    ...
    schedule on server-local time (x19_time._get_zoneinfo falls back with
    ...
    def test_invalid_or_non_string_zone_is_an_error(self):
        ...
        assert "IANA" in issue.hint and "X19_TIMEZONE" in issue.hint
...
class TestUnknownTopLevelKeys:
    ...
    (gateway/run.py, x19 send) so users can feed skills and external apps
