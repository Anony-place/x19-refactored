...
def test_message_pages_identify_the_serving_profile(tmp_path, monkeypatch, serving_profile):
    ...
    monkeypatch.setenv("X19_HOME", str(work_home))
    # conftest redirects this legacy override independently of X19_HOME.
    monkeypatch.setattr("x19_state.DEFAULT_DB_PATH", work_home / "state.db")
    ...
    from x19_cli.web_routers.sessions import manage_router
