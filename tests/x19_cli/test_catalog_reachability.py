...
Run before any catalog commit:
    ...
    X19_TEST_NETWORK=1 scripts/run_tests.sh tests/x19_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("X19_TEST_NETWORK"),
    reason="network test; set X19_TEST_NETWORK=1 to run",
)
