...
from x19_cli.commands import GATEWAY_KNOWN_COMMANDS, SUBCOMMANDS, gateway_help_lines, resolve_command
from x19_cli.commands_completion import SlashCommandCompleter
from x19_cli.commands_platforms import telegram_bot_commands
...
def _isolate_config(monkeypatch, home):
    ...
    monkeypatch.setenv("X19_MANAGED_DIR", str(home / "missing-managed"))
    from x19_cli import managed_scope
    from x19_cli.config import _LOAD_CONFIG_CACHE, _RAW_CONFIG_CACHE
