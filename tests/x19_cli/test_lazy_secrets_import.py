"""Regression test: x19 update must not load cryptography eagerly."""
...
assert 'x19_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running x19 update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so x19_cli is importable,
