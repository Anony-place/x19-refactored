"""Tests for ``x19 approvals suggest`` (x19_cli/approvals_suggest.py).

Approval history in X19 is implied, not ledgered: the session DB
...
from x19_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
