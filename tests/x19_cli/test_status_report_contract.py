...
Every surface renders through ``x19_cli.status_report.build_status_fields``; each keeps
...
def test_three_status_surfaces_report_the_same_common_fields():
    with patch("x19_constants.display_x19_home", return_value=HOME), \
