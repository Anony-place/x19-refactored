...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (x19_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_x19_overlays():
    """x19_cli.providers.get_provider("vertex") backs
