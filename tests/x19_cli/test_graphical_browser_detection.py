"""Tests for `_can_open_graphical_browser()` in x19_cli.auth.

Guards the fix for the May 2026 report where `x19 auth add xai-oauth`
...
from x19_cli.auth import _can_open_graphical_browser
