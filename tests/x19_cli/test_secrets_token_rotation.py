"""Tests for `x19 secrets bitwarden token` / `x19 secrets onepassword token`.
...
from x19_cli import onepassword_secrets_cli as op_cli
from x19_cli import secrets_cli as bw_cli
