...
Covers the pure helpers in ``x19_cli.partial_compress`` plus alias
...
from x19_cli.commands import COMMANDS, resolve_command
from x19_cli.partial_compress import (
    DEFAULT_KEEP_LAST,
