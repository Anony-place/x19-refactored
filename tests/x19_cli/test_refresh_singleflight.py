...
from x19_cli.dashboard_auth import refresh_singleflight as replay
from x19_cli.dashboard_auth.base import ProviderError, RefreshExpiredError, Session
from x19_cli.dashboard_auth.routes import router
...
def test_cookie_gate_burst_with_stale_rt_rotates_once(gated_web_app):
    ...
    cookies = {"x19_session_at": "expired-at", "x19_session_rt": "stale-rt",
               "x19_session_provider": "stub"}
