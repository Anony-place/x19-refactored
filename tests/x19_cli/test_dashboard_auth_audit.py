...
Profile-aware location: ``$X19_HOME/logs/dashboard-auth.log``.
...
from x19_cli.dashboard_auth.audit import audit_log, AuditEvent


@pytest.fixture
def profile_home(tmp_path, monkeypatch):
    """Redirect $X19_HOME and ~ to a tmp dir for the duration of the test."""
    home = tmp_path / ".x19"
    home.mkdir()
