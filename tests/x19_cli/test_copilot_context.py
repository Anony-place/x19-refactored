...
class TestGetCopilotModelContext:
    ...
    @patch("x19_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("x19_cli.models._urlopen_model_catalog_request")
    ...
    @patch("x19_cli.models.fetch_github_model_catalog", return_value=[])
