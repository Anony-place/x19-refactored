"""Fetch-failure classification for `x19 update` / `x19 update --check`.
...
CURL_429_STDERR = (
    "fatal: unable to access 'https://github.com/Anony-place/x19-refactored.git/':"
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `x19 update` sit on
    ...
    from x19_cli import update_cmd_git
