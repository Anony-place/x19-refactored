"""Tests for the shared tar.gz writer (``x19_cli.archive_safe.make_targz``).

``make_targz`` backs both ``x19 profile export`` and ``x19 kanban
...
from x19_cli.archive_safe import make_targz
