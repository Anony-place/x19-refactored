"""Tests for the ``x19 prompt-size`` diagnostic (issue #34667)."""
...
from x19_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(x19_home, memory_text="", user_text=""):
    mem_dir = x19_home / "memories"
...
def _seed_skill(x19_home, name, description):
    skill_dir = x19_home / "skills" / "demo" / name
