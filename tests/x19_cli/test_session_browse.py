"""Tests for the interactive session browser (`x19 sessions browse`).
...
from x19_cli.sessions_cmd_browse import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """x19 sessions browse should be parseable."""
