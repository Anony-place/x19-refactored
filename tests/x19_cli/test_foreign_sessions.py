"""Tests for x19_cli.foreign_sessions — Claude Code / Codex CLI import.

Fixture JSONL is synthesized inline (tmp_path); the SessionDB is opened
against a temp path so nothing touches the real X19_HOME store.
"""
...
from x19_cli.foreign_sessions import (
    _list_sessions,
