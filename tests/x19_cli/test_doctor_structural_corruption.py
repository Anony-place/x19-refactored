...
from x19_cli.doctor_state import _state_db_health
from x19_state import SessionDB
from x19_state_repair import integrity_damage_is_structural, state_db_has_structural_damage
...
def test_doctor_routes_structural_damage_to_recover_not_fts_rebuild(tmp_path, monkeypatch):
    ...
    .malformed-backup, nothing fixed) and must point at `x19 sessions recover` for THIS
