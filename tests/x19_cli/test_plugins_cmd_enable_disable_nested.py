...
the *mutation* side: `x19 plugins enable/disable` must resolve a bare name
...
class TestEnableDisableNested:
    @patch("x19_cli.plugins.get_bundled_plugins_dir")
    @patch("x19_cli.plugins_cmd._plugins_dir")
    @patch("x19_cli.plugins_cmd._save_disabled_set")
    @patch("x19_cli.plugins_cmd._save_enabled_set")
    @patch("x19_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("x19_cli.plugins_cmd._get_enabled_set", return_value=set())
...
class TestEnableToolOverrideConsent:
    ...
    @patch("x19_cli.plugins.get_bundled_plugins_dir")
    @patch("x19_cli.plugins_cmd._plugins_dir")
    @patch("x19_cli.plugins_cmd._set_plugin_entry_flag")
    @patch("x19_cli.plugins_cmd._save_disabled_set")
    @patch("x19_cli.plugins_cmd._save_enabled_set")
    @patch("x19_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("x19_cli.plugins_cmd._get_enabled_set", return_value=set())
...
class TestCompositeMenuWritesCanonicalKey:
    """#40190 follow-up: the interactive `x19 plugins` menu must persist
    ...
    def test_fallback_unchecked_plugin_disables_by_key_not_name(
        ...
        from x19_cli.plugins_cmd import _run_composite_fallback
