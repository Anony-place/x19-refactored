...
import x19_cli.macos_tcc_anchor as tcc
...
class TestUvStoreDetection:
    ...
    def test_matches_x19_runtime_repair_generation(self):
        path = (
            "/Users/u/x19/.x19-runtime/python/"
...
class TestEnsureTccAnchor:
    ...
    def test_store_root_marker_tracks_managed_uv_constant(self):
        ...
        from x19_cli.managed_uv import _RUNTIME_DIR_NAME
