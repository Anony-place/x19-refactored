...
# ---------------------------------------------------------------------------
# Thread-safe cache entry update (x19_cli/models.py)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Parallel prefetch (x19_cli/model_switch.py)
# ---------------------------------------------------------------------------
...
class TestPrefetchProviderModelsParallel:
    ...
    def test_skips_all_fresh_entries(self, monkeypatch):
        ...
        from x19_cli.model_switch_providers import _prefetch_provider_models_parallel
        ...
        with patch("x19_cli.models._load_provider_models_cache", return_value=fresh_cache), \
             patch("x19_cli.models._credential_fingerprint", return_value="fp"), \
             patch("x19_cli.models.cached_provider_model_ids") as fetch:
    ...
    def test_fetches_only_stale_entries(self, monkeypatch):
        ...
        with patch("x19_cli.models._load_provider_models_cache", return_value=cache), \
             patch("x19_cli.models._credential_fingerprint", return_value="fp_f"), \
             patch("x19_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("x19_cli.models.update_provider_cache_entry"):
    ...
    def test_fetches_in_parallel(self, monkeypatch):
        ...
        with patch("x19_cli.models._load_provider_models_cache", return_value={}), \
             patch("x19_cli.models._credential_fingerprint", return_value="fp"), \
             patch("x19_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("x19_cli.models.update_provider_cache_entry"):
    ...
    def test_empty_list_is_noop(self):
        ...
        with patch("x19_cli.models.cached_provider_model_ids") as fetch:
