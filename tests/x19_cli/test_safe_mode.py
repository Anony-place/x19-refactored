"""Tests for `x19 chat --safe-mode` isolation."""
...
_VARS = ("X19_SAFE_MODE", "X19_IGNORE_USER_CONFIG", "X19_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["X19_SAFE_MODE"] == "1"
        assert os.environ["X19_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["X19_IGNORE_RULES"] == "1"
        return True
