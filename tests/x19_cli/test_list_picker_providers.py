...
import x19_cli.model_switch_providers as x19_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(x19_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("x19_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import x19_cli.models as hm
    import x19_cli.models_catalog_static as x19_cli_models_catalog_static
    from x19_cli import models_catalog_static
    ...
    monkeypatch.setattr(x19_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
