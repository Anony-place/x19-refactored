...
The main() function in x19_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `x19 -c model`
...
def _build_parser():
    """Build a minimal replica of the x19 top-level parser."""
