...
def test_retirement_reserves_admission_until_cancel_or_permanent_commit(monkeypatch):
    ...
    from x19_cli import backend_retirement
    ...
    headers = {"X-X19-Session-Token": "retirement-test-token"}
...
def test_only_uncommitted_permits_expire_and_unreadable_work_never_grants(monkeypatch):
    from x19_cli.backend_retirement import RetirementFence
    from x19_cli import web_server_idle_proof
