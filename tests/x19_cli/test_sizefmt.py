"""Tests for the shared byte formatter (x19_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from x19_cli.backup import _format_size as backup
    from x19_cli.checkpoints import _fmt_bytes as checkpoints
    from x19_cli.sizefmt import format_bytes as doctor
