"""Catalog-aware ``x19 plugins`` surface (x19_cli/plugins_cmd_catalog.py): a bare catalog name installs
...
from x19_cli import plugins_cmd_catalog as cat
...
def test_owner_repo_hash_subdir_shorthand_resolves_like_the_catalog_spelling():
    from x19_cli.plugins_cmd import _resolve_git_url
    assert _resolve_git_url("plastic-labs/honcho#x19-plugin-honcho") == (
        "https://github.com/plastic-labs/honcho.git", "x19-plugin-honcho")
