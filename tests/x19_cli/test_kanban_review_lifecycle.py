...
from x19_cli import kanban_ops
...
def test_complete_task_closes_review_to_done(kanban_home: Path) -> None:
    ...
    with kbc.connect() as conn:
        ...
        # make `x19 kanban complete` a no-op (#54823).
...
def test_review_dispatch_gate_prevents_phantom_reviewer(
    ...
    import x19_cli.profiles as profmod
...
def test_dispatch_text_and_daemon_stuck_warning_name_guard_reason(
    ...
    """The plain `x19 kanban dispatch` output and the standalone daemon's
