...
The unit tests in tests/x19_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned x19-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/x19")
from x19_cli.service_manager import S6ServiceManager
