"""The `x19` skill is what a running X19 knows about itself.

`website/` is never packaged, so an installed X19 has no local copy of the
user guide; skills ARE synced into `$X19_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "X19 can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "x19"
