...
class TestRealWorldOutput:
    ...
    REAL = (
        ...
        "Uploaded x19-temp-hello (0.74 sec)\n"
        "Deployed x19-temp-hello triggers (0.42 sec)\n"
        "  https://x19-temp-hello.serene-temple.workers.dev\n"
    )
    ...
    def test_all_fields_from_real_output(self):
        r = pdo.parse(self.REAL)
        assert r["live_url"] == "https://x19-temp-hello.serene-temple.workers.dev"
