"""Plugin data paths follow the active profile's X19_HOME, including the ContextVar override.

Several plugins carried a ``~/.x19`` fallback (guarding an ImportError of ``x19_constants``
...
def _openviking_log(home):
    ...
    return ov.get_x19_home() / ov._OPENVIKING_SERVER_LOG_RELATIVE_PATH
