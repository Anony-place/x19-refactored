...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.x19/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at x19_state import time, before pytest's X19_HOME monkeypatch
    fires — the autouse fixture's X19_HOME override doesn't help here.)
    """
    import x19_state
