...
def test_import_loads_env_from_x19_home(tmp_path, monkeypatch):
    home = tmp_path / ".x19"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-x19-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-x19-home"
