...
Keeps the ACP server tests offline: ``X19ACPAgent._build_model_state``
calls ``x19_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import x19_cli.inventory as inventory
