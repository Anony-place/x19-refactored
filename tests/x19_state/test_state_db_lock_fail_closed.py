...
work on a file several X19 processes share (gateway service, the Desktop
app's `x19 serve` backend, CLI sessions, the TUI slash worker):

* `x19_state_common.fts_rebuild_admission` — full structural FTS rebuilds
* `x19_state_repair._cross_process_repair_lock`   — writable_schema surgery / VACUUM
