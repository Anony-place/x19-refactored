"""Session <-> workspace grouping key (x19_state_sessions.workspace_key).

The key is what `x19 sessions list --workspace` groups/filters on. It is a
...
import x19_state_sessions
from x19_state_sessions import workspace_key
