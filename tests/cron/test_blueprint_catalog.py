...
the shared /blueprint command handler (x19_cli/blueprint_cmd.py), and
the docs generator. Uses an isolated X19_HOME for anything that touches the
cron job store.
"""
...
class TestRenderers:
    ...
    def test_deeplink_shape(self):
        ...
        assert url.startswith("x19://blueprint/morning-brief?")
