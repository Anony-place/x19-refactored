...
Run after changing any ``desktop=`` value or alias in ``x19_cli/commands.py``;
``tests/x19_cli/test_desktop_slash_registry.py`` fails until the committed
...
def render() -> str:
    ...
    from x19_cli.commands import desktop_surface_registry
