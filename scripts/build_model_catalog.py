#!/usr/bin/env python3
"""Build the X19 Model Catalog — a centralized JSON manifest of curated models.
...
X19 CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping an X19 release.
...
# Ensure X19_HOME is set for imports that touch it at module level.
os.environ.setdefault("X19_HOME", os.path.join(os.path.expanduser("~"), ".x19"))

from x19_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "x19 repo",
            "docs": "https://anony-place.github.io/x19-refactored/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model X19 '
