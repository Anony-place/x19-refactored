...
_BASELINE = frozenset(
    {
        "tests/x19_cli/test_doctor.py",
        "tests/x19_cli/test_gateway.py",
        "tests/x19_cli/test_gateway_proc_fallback.py",
        "tests/x19_cli/test_linux_sandbox_fixup.py",
        "tests/x19_cli/test_macos_fda_guidance.py",
        "tests/x19_cli/test_orphan_desktop_serve_reap.py",
        "tests/x19_cli/test_update_launchd_restart_verification.py",
        "tests/x19_cli/test_update_launchd_unloaded_gateway.py",
        "tests/x19_cli/test_urllib_security.py",
        "tests/x19_state/test_state_synchronous_pragma.py",
        "tests/test_x19_constants.py",
