...
def main() -> None:
    ...
    x19_home = Path(tempfile.mkdtemp(prefix="x19-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "x19-gateway-smoke",
    ...
    print(json.dumps({"x19_home": str(x19_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
