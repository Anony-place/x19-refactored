#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from X19 logs.
...
With no LOGFILE, reads ``$X19_HOME/logs/agent.log`` (default ~/.x19).
...
def default_log() -> Path:
    home = os.environ.get("X19_HOME") or str(Path.home() / ".x19")
