#!/usr/bin/env python3
"""Build the X19 Skills Index — a centralized JSON catalog of all skills.
...
`x19 skills search/install` can use it without hitting the GitHub API.
...
# Ensure X19_HOME is set (needed by tools/skills_hub*.py imports)
...
def main():
    print("Building X19 Skills Index...", flush=True)
