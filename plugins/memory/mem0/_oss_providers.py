...
VECTOR_PROVIDERS: dict[str, dict[str, Any]] = {
    ...
    # not an import-time constant, and ``~/.x19`` is wrong on Windows and under profiles.
    "qdrant": {"label": "Qdrant", "default_config": {"path": lambda: str(get_x19_home() / "mem0_qdrant")}, "pip_dep": "qdrant-client"},
    "pgvector": {
        "label": "PGVector",
