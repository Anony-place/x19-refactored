...
# Author ids the bot-mode dispatcher assigns to other X19 profiles (tools/bot_relay.py).
...
def assistant_peer_id_for(config: Any) -> str:
    ...
    return sanitize_peer_id(getattr(config, "ai_peer", None) or "x19-assistant")
