...
via :func:`x19_cli.runtime_provider.resolve_runtime_provider`. OpenRouter alone also
...
_ATTRIBUTION_HEADERS = {
    ...
    "HTTP-Referer": "https://github.com/Anony-place/x19-refactored",
    "X-Title": "X19 Agent",
}
        ...
        **kwargs: Any,
        ...
        if not api_key or not base_url:
            return fail(
                ...
                f"Configure {self._display} in `x19 tools` → Image Generation.",
                "missing_api_key")
