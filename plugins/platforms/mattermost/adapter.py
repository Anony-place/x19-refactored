...
def interactive_setup() -> None:
    ...
    from x19_cli.cli_output import prompt, print_header, print_info, print_success
    ...
    print()
    info("📬 Home Channel: where X19 delivers cron job results and notifications.",
    ...
    print_info("   Open config in your editor:  x19 config edit")
