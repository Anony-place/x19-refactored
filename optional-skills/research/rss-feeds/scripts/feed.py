...
Standard library only, so it runs in any X19 environment without an install
...
USER_AGENT = "x19/1.0 (rss-feeds skill; +https://github.com/Anony-place/x19-refactored)"
TIMEOUT = 20
NS = {
