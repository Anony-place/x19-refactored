...
- **Note:** The previous Open Refine reconciliation endpoint at
  ...
  the ZIP locally (default `~/.cache/x19-osint/icij/`, refreshes after
...
First call downloads the ~70 MB ZIP under `~/.cache/x19-osint/icij/`
(or `$X19_OSINT_CACHE/icij/`). Subsequent calls reuse the cache for 30 days.
