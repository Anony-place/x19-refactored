...
Data file: $X19_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_X19_HOME = Path(os.environ.get("X19_HOME", Path.home() / ".x19"))
DATA_DIR = _X19_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
