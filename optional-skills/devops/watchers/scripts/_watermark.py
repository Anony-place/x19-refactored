...
def _state_dir() -> Path:
    ...
    # Default: $X19_HOME/watcher-state/, falling back to ~/.x19/watcher-state/.
    x19_home = os.environ.get("X19_HOME") or str(Path.home() / ".x19")
    return Path(x19_home) / "watcher-state"
