...
// reads X19_GUEST_ONBOARDING and treats exactly "1" as on; the desktop
...
export const GUEST_ONBOARDING_ENV = 'X19_GUEST_ONBOARDING'
...
// on every fresh X19_HOME. The guide still runs — only the film is
// skipped. Renderer-only; the backend never sees it.
export const SKIP_INTRO_ENV = 'X19_SKIP_INTRO'
