 ...
 *     it via `x19:profile:remember` without re-homing the primary.
 ...
 * the same X19_HOME. That duplicate held a pool slot and starved every other
...
export class PrimaryProfilePin {
  ...
  /** Called by startX19() with the profile the primary is launching as. */
