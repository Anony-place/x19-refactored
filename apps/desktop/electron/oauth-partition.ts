 ...
 * (`persist:x19-remote-oauth`) — the jar was keyed on the auth *mode*, not
 ...
 * setup: one box, two dashboards) fought over the same `x19_session*`
...
export const LEGACY_OAUTH_PARTITION = 'persist:x19-remote-oauth'
...
// `Partitions/x19-remote-oauth%3Aconn%3A<id>` folder is left on disk,
