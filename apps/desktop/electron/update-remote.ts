 ...
 *
 * A public install can end up with `origin=git@github.com:Anony-place/x19-refactored.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/Anony-place/x19-refactored.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/Anony-place/x19-refactored'
