...
// by main.ts (`setBackgroundThrottling` driven by the merged `x19:active-work`
...
// (the "X19 idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey X19" wake word has NO preceding click,
