...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\x19\x19\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@x19/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@x19/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@x19/shared/color': path.resolve(__dirname, '../shared/src/color.ts'),
      '@x19/shared': path.resolve(__dirname, '../shared/src'),
