...
cd apps/desktop
XCURSOR_SIZE=24 X19_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/x19-typing
# → /tmp/x19-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/x19-typing.before.heapsnapshot
# → /tmp/x19-typing.after.heapsnapshot
```
