...
import { saveMemoryProviderConfig } from '@/x19'
import { ExternalLink, Loader2, Save, SlidersHorizontal } from '@/lib/icons'
import { notify, notifyError } from '@/store/notifications'
import { $activeGatewayProfile } from '@/store/profile'
import type { MemoryProviderConfig, MemoryProviderField } from '@/types/x19'
          ...
          {config.docs_url && (
            <a
              ...
              onClick={event => {
                ...
                void window.x19Desktop?.openExternal?.(config.docs_url)
              }}
              rel="noreferrer"
              target="_blank"
            >
