...
export interface TitlebarChromeContext {
  ...
  windowButtonPosition?: X19Connection['windowButtonPosition']
}
...
export function titlebarControlsPosition(
  windowButtonPosition: X19Connection['windowButtonPosition'] | undefined,
  isFullscreen = false
) {
...
export const TITLEBAR_CHROME_CHANGED_EVENT = 'x19:titlebar-chrome-changed'
