...
describe('renderRpcResult', () => {
  ...
  describe('session.save', () => {
    it('echoes the saved file path', () => {
      expect(renderRpcResult({ file: '/home/user/.x19/sessions/saved/x.json' }, 'save')).toBe(
        'Saved transcript to /home/user/.x19/sessions/saved/x.json'
      )
    })
  })
