...
const TAKEOVER_KEY = 'x19.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which X19 can't clear via the API — the user
 *  sees exactly what runs instead of X19 silently deleting their creds. */
