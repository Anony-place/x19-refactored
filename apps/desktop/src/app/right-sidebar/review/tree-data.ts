import type { X19ReviewFile } from '@/global'
...
export function buildReviewFlatList(files: X19ReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: X19ReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
