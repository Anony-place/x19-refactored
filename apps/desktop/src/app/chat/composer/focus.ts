...
const FOCUS_EVENT = 'x19:composer-focus'
const INSERT_EVENT = 'x19:composer-insert'
const ATTACH_IMAGES_EVENT = 'x19:composer-attach-images'
const INSERT_REFS_EVENT = 'x19:composer-insert-refs'
const SUBMIT_EVENT = 'x19:composer-submit'
const VOICE_TOGGLE_EVENT = 'x19:composer-voice-toggle'
const MODEL_MENU_EVENT = 'x19:composer-model-menu'
