...
import type { ProjectInfo, SessionInfo } from '@/x19'
 ...
 * repo shows its branches/worktrees even when they have no X19 sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: X19GitWorktree[]
): SidebarSessionGroup[] {
