...
import { getLatestSessionMessages, type ProfileScope } from '@/x19'
...
interface BackgroundSyncParams {
  ...
  refreshX19Config: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshX19Config])
}
