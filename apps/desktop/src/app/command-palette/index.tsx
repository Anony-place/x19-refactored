...
import { getX19ConfigRecord, listAllProfileSessions } from '@/x19'
...
// X19 session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-x19',
            keywords: ['update', 'upgrade', 'x19', 'version', 'system', 'restart'],
            label: cc.updateX19,
