 ...
 * `<x19 home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'x19.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'x19.desktop.disabledPlugins.v1'
