...
export const en: Translations = {
  catalog: {
    ...
    snapshotHint: 'From the X19 catalog. Browsing never contacts source repositories.',
  ...
  connectors: {
    ...
    disclaimer: 'Connecting is optional. Only authorize the apps you want X19 to use.',
    execution: 'Connector tools'
  },

  sessionImport: {
    title: 'Continue from another app',
    subtitle: 'Bring a conversation into X19 and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into X19.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in X19. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in X19',
    continue: 'Continue in X19',
  ...
  boot: {
    ready: 'X19 Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading X19 settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote X19 backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingX19Desktop: 'Starting X19 Desktop…'
    },
    errors: {
      ...
      backgroundExitedDuringStartup: 'X19 stopped right after it started.',
      backendStopped: 'X19 stopped working in the background',
      restartX19: 'Restart X19',
      openLogs: 'Open logs',
      desktopBootFailed: "X19 couldn't start",
      gatewayConnectionLost: 'X19 lost its connection',
      ...
      gatewaySignInRequired: 'Your remote X19 signed you out',
      gatewaySignInRequiredDetail: 'Sign in again to reconnect. Your chats and settings are safe.',
      signInAgain: 'Sign in again',
      ipcBridgeUnavailable: "X19 Desktop couldn't talk to its own background layer. Restart the app."
    },
    // Plain causes for a local backend boot failure (`classifyBootFailure`);
    // the raw output stays behind "Show recent logs".
    causes: {
      exitedEarly: "X19' background service stopped right after starting.",
      timedOut: "X19' background service didn't answer in time.",
      permission: "X19 couldn't write to its data folder (permission problem).",
      diskFull: 'The disk is full, so X19 could not start.',
      portInUse: 'Another program is using the network port X19 needs.',
      installMissing: "Part of X19' installation is missing. Choose Repair install to put it back."
    },
    failure: {
      title: "X19 couldn't start",
      description:
        "X19' background service didn't come up. Try one of the recovery steps below. Nothing here deletes your chats or settings.",
      details: 'Details',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your X19 backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateX19: 'Update X19',
    ...
    errors: {
      ...
      storageFailure: "X19 couldn't save to its data folder. Open Maintenance to check and repair it.",
      gatewayAuthFailed:
        'This X19 no longer accepts your saved sign-in. Open Gateways and sign in again (or paste a new access token), then retry.',
      methodNotAllowed: "X19' background service is out of step with the app, probably after an update. Restart it to fix this.",
      ...
      codeSkewRestartRequired: 'X19 was updated but is still running the old version. Restart it to finish the update.',
      restartX19Failed: "Couldn't restart X19"
    },
    actions: {
      restartX19: 'Restart X19',
      openKeys: 'Open Keys',
    ...
    voice: {
      ...
      liveDelegationFailed: 'Could not hand the request to X19',
    ...
    native: {
      ...
      inputBody: 'X19 is waiting for your response.',
      turnDoneTitle: 'X19 finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `x19 debug share --nous` from a terminal, or `x19 debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to X19 defaults?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `X19 catalog entry "${name}" — the agent component installs at the reviewed pin${sha ? ` ${sha}` : ''}, not the branch tip.`,
    ...
    vault: {
      ...
      otpHint: 'The "setup key" the site shows when you enable 2FA. With it saved, X19 generates the codes itself.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Not detected. Install the ${name} command-line tool and sign in to it; X19 picks it up automatically.`,
        disabledDesc: 'Detected but turned off for X19.',
        lockedDesc: 'Detected. The agent will ask you to unlock it when it needs a login, or unlock now.',
        unlockedDesc: 'Unlocked for this session. Locks automatically after 30 minutes idle or when X19 closes.',
        statusLocked: 'Locked',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while X19 is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'X19 asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while X19 was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while X19 was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let X19 follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and X19 can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'Occasional hints from the app and X19. Each tip appears once. Turns off automatically after your first 30 days; you can turn it back on.',
      tipsReset: (count: number) => `Show ${count} ${count === 1 ? 'tip' : 'tips'} again`,
      toursTitle: 'Guided Tours',
      toursDesc:
        'Let X19 spotlight each step as it guides you through the app. Turns off automatically after your first 30 days; you can turn it back on.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what X19 is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen X19, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The X19 runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — X19 only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart X19',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'X19 checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading X19 configuration...',
    ...
    screenshot: {
      ...
      enabledDesc:
        'Press both Command keys together from any app to capture its frontmost window and attach it to your current X19 draft. Never sends automatically. Off by default; applies only to this Mac. Window contents may be sensitive — review the attachment before sending.',
      ...
      inputPermission:
        'Input Monitoring permission lets X19 detect both Command keys while another app is active. Allow X19 in System Settings → Privacy & Security → Input Monitoring, then return here and retry.',
      screenPermission:
        'Screen Recording permission lets X19 capture the frontmost app window when you use this shortcut. Allow X19 in System Settings → Privacy & Security → Screen Recording, then return here and retry. Restart X19 if macOS asks.',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening X19.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every X19 gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by X19 Cloud',
      kindLocal: 'Local',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers X19 manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under X19 Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      unavailableDesc: 'Connection settings can only be changed from the X19 Desktop app on the computer running it.',
      ...
      localDesc: 'Start a private X19 backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote X19 backend.',
      ...
      cloudDesc: 'Sign in once to X19 Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'X19 Cloud',
      cloudSignIn: 'Sign in to X19 Cloud',
      cloudSignedIn: 'Signed in to X19 Cloud',
      cloudNeedsSignIn: 'Sign in to X19 Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your X19 Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'X19 Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of X19 Cloud',
      cloudSignedOutMessage: 'Cleared the X19 Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /x19.',
      probing: 'Checking how this gateway authenticates…',
      probeError: "X19 can't reach that address. Check the URL and that the other computer is running X19 — sign-in options appear once it answers.",
      signedIn: 'Signed in',
      signIn: 'Sign in',
      signOut: 'Sign out',
      ...
      restartingMessage: 'X19 Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · X19 ${version}` : ''}`,
      ...
      sshDesc:
        'X19 is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshX19PathTitle: 'X19 path (optional)',
      sshX19PathDesc: 'Full path to the remote x19 binary. Blank = auto-detect.',
      sshX19PathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — X19 found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — X19 runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'X19 is not installed on the remote host. Install it there (curl -fsSL https://raw.githubusercontent.com/Anony-place/x19-refactored/main/scripts/install.sh | sh) or set the X19 path.',
      sshErrPlatform:
        'Unsupported remote platform. X19 Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update X19 on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to X19. Review the exact configuration below — it comes from the link, not from X19.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. X19 starts and manages the server for you.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. X19 runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point X19 at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      terminalBackend: {
        ...
        unavailableMessage: backend =>
          `X19 can't run shell commands right now: ${backend} isn't ready. Switch to Local, or finish setting up ${backend} and try again.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let X19 browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via x19 curator restore.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      legacyBackend: 'This backend predates key-addressed plugin toggles — update X19 to manage it here.',
      ...
      catalogProvenance: (sha: string) => `Installed from the X19 catalog${sha ? ` at pin ${sha}` : ''}.`,
  ...
  starmap: {
    ...
    emptyDesc: 'As X19 builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart X19 to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update X19 to generate pets.',
      backgroundHint: 'You can close this — X19 will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure X19 desktop' },
    ...
    x19ActiveSessions: (version, count) => `X19 ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    restartFailedManual: "X19 couldn't restart to apply your messaging settings",
    ...
    telegramQr: {
      ...
      subtitle: 'Both options connect a bot you control and save its credentials only to this X19 installation.',
      quickSetup: 'Quick setup',
      recommended: 'Recommended',
      quickHelp:
        'Scan a QR code and confirm in Telegram. X19 creates the bot and detects your Telegram user ID automatically.',
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@x19:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote X19 you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://x19.example.com',
    ...
    defaultDescription: 'Used when X19 opens and for new chats. Existing sessions stay in their profiles.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent X19 environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'X19 did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. X19 will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the X19 backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from X19. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the X19 backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting X19...',
    placeholderReconnecting: 'Reconnecting to X19…',
    ...
    voiceEngineChained: 'Speech-to-text + X19 voice',
    voiceEngineLive: 'GPT-Live (full-duplex, delegates to X19)',
    ...
    attachUrlDesc: 'X19 will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of X19 can’t update itself from inside the app.',
    connectionRetry:
      "X19 couldn't reach the update server. Check your internet connection and try again. If you use a remote X19, make sure it is online.",
    connectionSettings: 'Connection settings',
    ...
    manualBody: 'You installed X19 from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'X19 will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the X19 desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The X19 updater takes over in its own window and reopens X19 automatically when it’s done. Please don’t reopen X19 yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. X19 reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then X19 reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update X19?',
    blockerBody:
      'X19 needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update X19',
    foreignBlockerBody:
      'X19 can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'X19 can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  handoffTour: {
    ...
    stayTitle: 'X19 is one click away',
    stayText: 'Switch to the setup profile and open Welcome to X19 whenever you want a hand. It stays there.'
  },
  guidedGreeting: {
    line: "Hey, come on in. I'm X19. Give me two minutes to set the place up around you, then we'll put me to work on something you actually want done.\n\nFirst though, what should I call you?",
  ...
  install: {
    ...
    oneTimeTitle: 'X19 needs a one-time install',
    ...
    installLocalTitle: 'Install X19 locally',
    installLocalDesc: 'Download X19, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart X19 Desktop and try again.',
    remoteSetupTitle: 'Connect to existing X19',
    remoteSetupDesc: 'Enter your gateway URL. X19 Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the X19 gateway, including https:// when remote.',
    ...
    settingUpTitle: 'Setting up X19',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the setup steps did not finish. This can happen when another copy of X19 is running, the internet connection dropped, or antivirus blocked the installer. Close other X19 windows, then choose Reload and retry. If it fails again, open the logs and send them to support.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with X19",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'X19 is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting X19…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run X19',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point X19 at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — X19 connects automatically',
    ...
    authorizeThere: 'Authorize X19 there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize X19 there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  freeTier: {
    ...
    retiredBody:
      'Your session ended before the sign-in finished. X19 will start a new one; then sign in again whenever you\'re ready.',
    errorBody: "Sign-in didn't finish. Try again whenever you're ready.",
    busyHeading: 'Almost there',
    busyBody: wait =>
      `X19 couldn't finish signing you in because the Nous service is busy. Try again in ${wait}. Your session is still here in the meantime.`,
    unreachableBody:
      "X19 couldn't reach the Nous service to finish signing you in. Check your internet connection and try again. Your session is still here.",
    alreadySignedInHeading: 'Already signed in.',
    alreadySignedInBody: 'This X19 is already signed in to a Nous account.',
    setupFailed: {
      gateClosed:
        "This version of X19 can't start without a Nous account. Sign in or create one, it's free and only takes a minute.",
      paused:
        'Using X19 without signing in is paused for a moment. X19 will keep checking. Signing in is free and gets you going right now.',
      rateLimited: wait =>
        `Lots of people are getting started right now, so X19 will try again in ${wait}. Signing in is free and skips the wait.`,
      unreachable:
        "X19 couldn't reach the Nous service. Check your internet connection, then tap Try again. Or connect another provider for now.",
      ...
      generic: "X19 couldn't set up free access without signing in. Signing in is free, or connect another provider.",
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. X19 will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'X19 is restarting...',
      askRestart: 'Ask X19 to restart the server',
      lookingRestart: taskId => `X19 is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'X19 is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask X19 to open a page.',
      finishedRestarting: message => `X19 finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'X19 could not restart the server.',
      stillWorking:
        'X19 is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'X19 is loading a response',
      ...
      errorLayers: {
        ...
        gateway: 'X19 hit a problem',
        generic: "X19 couldn't finish this reply",
        provider: 'The AI service returned an error',
        runtime: 'X19 hit a problem',
      ...
      errorLayerBodies: {
        ...
        disk: 'Your disk is full, so X19 could not save this conversation. Free some space, then retry.',
        endpoint: "X19 can't reach your custom model server. Check that it is running, then send your message again.",
        gateway: 'X19 hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
        generic: 'Something went wrong while X19 was replying. Retry, or copy the details if it keeps happening.',
        provider: 'The AI service could not complete this request. Retry in a moment or switch provider.',
        runtime: 'X19 hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: provider =>
            `X19 could not verify the secure connection to ${provider}. Check your network or proxy settings, or switch provider, then send your message again.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: provider => `${provider} returned something X19 could not read. Retry in a moment.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'X19 got stuck in a loop',
          body: 'The reply kept repeating the same steps, so X19 stopped it. Retry, or start a new chat if it happens again.'
        },
        SESSION_NOT_OWNED: {
          title: 'This chat is open somewhere else',
          body: 'This chat is currently open in another X19 window or terminal. Close it there and send your message again, or start a new chat here.'
        },
        disk_full: {
          title: 'Disk full',
          body: 'Your disk is full, so X19 could not save this conversation. Free some space, then retry.'
        },
        ...
        free_tier_disabled: {
          title: 'Using X19 without signing in is switched off right now',
        ...
        free_tier_model_not_free: {
          ...
          body: "X19 uses the free model for now. Sign in with a Nous account for more models, it's free."
        },
        free_tier_route: {
          title: "X19 couldn't reach the free model on this route",
        ...
        free_tier_refused: {
          title: "X19 couldn't send that without signing in",
      ...
      errorToastTitle: "X19 couldn't finish the reply",
      errorRetry: 'Retry',
      ...
      errorOpenX19Folder: 'Open X19 folder',
      errorOpenX19FolderFailed: 'Could not open the X19 folder',
    ...
    approval: {
      gatewayDisconnected:
        'X19 is offline right now. The command is still waiting for your answer (until the approval timeout). Reconnect, then send it again.',
      sendFailed: 'Could not send your answer',
      reconnect: 'Reconnect',
      timedOutSystemLine:
        'Approval timed out — the command was not run. Ask X19 to try again, or raise the limit in Settings → Safety → Approval timeout.',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.x19/config.yaml). X19 won’t ask again for commands like this — in this session or any future one.`,
      alwaysAllow: 'Always allow'
    },
    clarify: {
      notReady: 'Clarify request is not ready yet',
      gatewayDisconnected: 'X19 is offline right now. Reconnect, then send it again.',
  ...
  prompts: {
    ...
    secretDesc: 'X19 needs a credential to continue.',
    ...
    vaultSaveDesc: origin =>
      `X19 reached a sign-in page at ${origin} and has no login for it. Enter it once here; it is encrypted on this machine and filled into the page without the model ever seeing the password.`,
    ...
    vaultCodeDesc: site =>
      `${site} is asking for a one-time code (text message, email or authenticator app). Enter it here and X19 types it into the page; the model never sees it.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      'Tip: save the authenticator key with this login in Settings → Passwords & Logins and X19 enters codes for you.',
    vaultCodeSkip: 'Skip',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart X19 Desktop to use Save Image.',
    restartToSaveImages: 'Restart X19 Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: "X19 couldn't reach your messaging connection. Start it from Settings → Messaging, then try the handoff again.",
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions X19 loads when the work calls for them.'
      },
      messaging: {
        title: 'X19 away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything X19 made',
      ...
      profiles: {
        ...
        text: 'Each one is its own X19 — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
