...
import { getX19ConfigRecord, type McpTestResult, setMcpServerEnabled, testMcpServer } from '@/x19'
...
const SNOOZE_KEY_PREFIX = 'x19:mcp-health-snooze-until:'
...
async function sweep(): Promise<void> {
  ...
  try {
    config = await getX19ConfigRecord()
  } catch {
