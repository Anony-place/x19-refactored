...
export interface PetInfo {
  ...
  // the X19 "run" activity state uses the in-place running row).
 ...
 * X19_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'x19.desktop.pet-roam.v1'
