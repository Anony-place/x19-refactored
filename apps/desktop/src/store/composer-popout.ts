...
const POPOUT_STORAGE_KEY = 'x19.desktop.composerPopout.window.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'x19.desktop.composerPopout.gesturesEnabled'
const ZONES_STORAGE_KEY = 'x19.desktop.composerPopout.zones.v1'
const LEGACY_ENABLED_KEY = 'x19.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'x19.desktop.composerPopout.position'
