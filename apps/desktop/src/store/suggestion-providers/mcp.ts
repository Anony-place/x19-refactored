...
import { addMcpServer, getMcpCatalog, listMcpServers, removeMcpServer } from '@/x19'
...
import type { McpCatalogEntry } from '@/types/x19'
 ...
 * `x19 mcp catalog`), by whole-word keyword and pasted-link host suffix,
