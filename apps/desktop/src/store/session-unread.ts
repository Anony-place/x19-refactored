...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('x19.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('x19.desktop.unreadFinishedSessions')
