...
// v1 (`x19.desktop.statusbarHidden`) was seeded with the approval pill
...
const STATUSBAR_HIDDEN_STORAGE_KEY = 'x19.desktop.statusbarHidden.v2'
const LEGACY_HIDDEN_STORAGE_KEY = 'x19.desktop.statusbarHidden'
// v1 (`x19.desktop.statusbarVisible`) shipped a stretch where the bar was
...
const STATUSBAR_VISIBLE_STORAGE_KEY = 'x19.desktop.statusbarVisible.v2'
