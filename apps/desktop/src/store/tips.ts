 ...
 * - It covers X19 too. "Off" from someone who has just closed a bubble means
...
const ENABLED_KEY = 'x19.desktop.tips.rotation.v1'

export const $tipsEnabled = persistentAtom(ENABLED_KEY, true, Codecs.bool)
export const $retiredTips = persistentAtom<string[]>('x19.desktop.tips.retired.v1', [], Codecs.stringArray)
export const $lastTipId = persistentAtom<null | string>('x19.desktop.tips.last.v1', null, Codecs.nullableText)
export const $nextTipAt = persistentAtom<null | number>(
  'x19.desktop.tips.next.v1',
  null,
