...
export const RECOVERY_ACTIONS = {
  restartX19: (): NotificationAction => ({
    label: translateNow('notifications.actions.restartX19'),
 ...
 *  (`x19_state_errors.classify_persistence_error`). */
...
const ERROR_SUMMARIES: ErrorSummaryRule[] = [
  ...
  },
  {
    ...
    action: () => RECOVERY_ACTIONS.restartX19()
  },
  {
