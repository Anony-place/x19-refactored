/**
 * X19 skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$X19_HOME/skins/` (or a
 * built-in) resolved by `x19_cli/skin_engine.py` and pushed to every surface
 ...
 * skin X19 authors from a prompt lights up all three surfaces from one file.
 *
...
import { ensureContrast, mix } from '@x19/shared/color'
import type { X19Skin, SkinColors } from '@x19/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: X19Skin): DesktopTheme | null {
