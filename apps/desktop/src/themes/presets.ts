...
import { THEME_PRESET_PALETTES } from '@x19/shared'
...
/**
 * Nous — the canonical X19 desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays X19's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical X19 desktop identity: GitHub's chrome carrying Nous
