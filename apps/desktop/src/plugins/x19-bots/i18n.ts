...
import { type PluginLocaleBundles, type PluginTranslate, usePluginI18n } from '@x19/plugin-sdk'
...
const en: BotsMessages = {
  roster: {
    ...
    rosterUnavailable: reason =>
      `Roster unavailable: ${reason}. If your gateway predates profiles.list, update X19 and restart the gateway.`,
    waitingForGateway:
  ...
  bot: {
    ...
    attentionMissingConfig: 'Provider not configured — run x19 model',
    ...
    openAnotherChatUnsupported: 'Update X19 Desktop to open another Bot chat.',
    remoteConnectionsUnsupported: 'Update X19 Desktop to chat with bots on other connections.',
    openNeedsUpdateTitle: 'This bot lives on an older X19',
    openNeedsUpdateMessage: connectionLabel => `Update ${connectionLabel}, then try again.`,
    openUnreachableTitle: 'X19 couldn’t reach the computer this bot runs on',
...
const ja: BotsMessages = {
  roster: {
    ...
    retryNow: '今すぐ再試行',
    rosterUnavailable: reason =>
      `名簿を取得できません: ${reason}。ゲートウェイが profiles.list より前の場合は、X19 を更新してゲートウェイを再起動してください。`,
  ...
  bot: {
    ...
    attentionMissingConfig: 'プロバイダーが未設定です — x19 model を実行してください',
    ...
    openAnotherChatUnsupported: '別のボットチャットを開くには X19 Desktop を更新してください。',
    remoteConnectionsUnsupported: '他の接続上のボットとチャットするには X19 Desktop を更新してください。',
    openNeedsUpdateTitle: 'このボットは古い X19 上で動いています',
    openNeedsUpdateMessage: connectionLabel => `${connectionLabel} を更新してから、もう一度お試しください。`,
    openUnreachableTitle: 'このボットが動いているコンピューターに X19 が接続できませんでした',
...
const zh: BotsMessages = {
  roster: {
    ...
    unavailable: '不可用',
    retryNow: '立即重试',
    rosterUnavailable: reason => `无法获取名单：${reason}。如果网关早于 profiles.list，请更新 X19 并重启网关。`,
  ...
  bot: {
    ...
    attentionMissingConfig: '未配置提供商 — 请运行 x19 model',
    ...
    openAnotherChatUnsupported: '请更新 X19 Desktop 以打开另一个机器人聊天。',
    remoteConnectionsUnsupported: '请更新 X19 Desktop 以与其他连接上的机器人聊天。',
    openNeedsUpdateTitle: '这个机器人运行在较旧的 X19 上',
    openNeedsUpdateMessage: connectionLabel => `请更新 ${connectionLabel}，然后重试。`,
    openUnreachableTitle: 'X19 无法连接到运行这个机器人的电脑',
...
const zhHant: BotsMessages = {
  roster: {
    ...
    unavailable: '不可用',
    retryNow: '立即重試',
    rosterUnavailable: reason => `無法取得名單：${reason}。如果閘道早於 profiles.list，請更新 X19 並重新啟動閘道。`,
  ...
  bot: {
    ...
    attentionMissingConfig: '未設定供應商 — 請執行 x19 model',
    ...
    openAnotherChatUnsupported: '請更新 X19 Desktop 以開啟另一個機器人聊天。',
    remoteConnectionsUnsupported: '請更新 X19 Desktop 以與其他連線上的機器人聊天。',
    openNeedsUpdateTitle: '這個機器人運行在較舊的 X19 上',
    openNeedsUpdateMessage: connectionLabel => `請更新 ${connectionLabel}，然後再試一次。`,
    openUnreachableTitle: 'X19 無法連線到運行這個機器人的電腦',
...
export function useBots(): BotsText {
  const t = usePluginI18n('x19-bots')
