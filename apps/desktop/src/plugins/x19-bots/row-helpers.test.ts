 ...
 *    the primary profile surfaced as @default instead of @x19;
 ...
 *    kanban/tool workers count too (x19#90268): a profile grinding
...
describe('previewKind classifies a roster preview', () => {
  ...
  it('surfaces the primary profile as @x19, never @default (#89484)', () => {
    expect(fromBot("Message from agent 'default': deploy is green")).toBe('x19')
