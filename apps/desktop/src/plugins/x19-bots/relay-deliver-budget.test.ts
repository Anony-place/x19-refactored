...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/x19-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'x19_cli/config_defaults.py'), 'utf8')
