...
import type { ConnectionTargetState } from '@x19/shared'
          ...
          const action =
            phase.verb === 'none'
              ...
              : {
                  ...
                  onClick: () => {
                    if (phase.verb === 'open' && target.connectUrl && window.x19Desktop?.openExternal) {
                      void window.x19Desktop.openExternal(target.connectUrl)
                    }
