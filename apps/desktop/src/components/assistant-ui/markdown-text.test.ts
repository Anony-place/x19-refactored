...
describe('preprocessMarkdown', () => {
  ...
  it('does not swallow trailing emphasis asterisks into an autolinked url', () => {
    const input = '**PR opened: https://github.com/Anony-place/x19-refactored/pull/12345**'
    ...
    expect(output).toContain('<https://github.com/Anony-place/x19-refactored/pull/12345>')
