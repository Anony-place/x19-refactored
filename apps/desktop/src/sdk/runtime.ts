 ...
 * plugins resolve `@x19/plugin-sdk` through the vite alias; RUNTIME-loaded
...
// `sdk/runtime` — so a module-scope `{ __X19_PLUGIN_SDK__: sdk, … }` is
...
// `Object.keys(GLOBALS.__X19_PLUGIN_SDK__)` threw
...
function pluginNamespaces() {
  return {
    __X19_PLUGIN_SDK__: sdk,
    __X19_REACT__: React,
    __X19_REACT_JSX__: jsxRuntime,
    __X19_REACT_JSX_DEV__: jsxDevRuntime
  }
}
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@x19/plugin-sdk': shimUrl('__X19_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__X19_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__X19_REACT_JSX__'),
    react: shimUrl('__X19_REACT__')
  }
