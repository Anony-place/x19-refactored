/** X19' reasoning levels, in ascending order — mirrors the backend's
 *  VALID_REASONING_EFFORTS (x19_constants.py). `none` is not a level: it's
 *  thinking disabled. */
...
/** X19' built-in level when neither the surface nor the profile config
