/**
 * Canonical X19 skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$X19_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`x19_cli/skin_engine.py`),
 ...
 *   • CLI     → `x19_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
