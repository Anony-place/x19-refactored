...
- Implement the relevant ABC and use the existing plugin discovery path (`~/.x19/plugins/`, project `.x19/plugins/`, or a pip entry point) — see [Build a X19 Plugin](https://anony-place.github.io/x19-refactored/docs/developer-guide/plugins)
