...
| [`x19`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-x19) | Use, configure, theme, extend, and orchestrate X19. | `autonomous-ai-agents\x19` |
...
| [`x19-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-x19-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development\x19-skill-authoring` |
| [`inspecting-x19-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-x19-desktop-dom) | Read the live X19 desktop DOM/CSS over CDP. | `software-development\inspecting-x19-desktop-dom` |
