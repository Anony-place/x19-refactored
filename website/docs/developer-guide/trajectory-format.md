...
X19 saves conversation trajectories in ShareGPT-compatible JSONL format
...
It follows the X19 function-calling prompt template with:
...
Trajectory saving is a `run_agent.py` / library-level switch — the `x19` CLI
