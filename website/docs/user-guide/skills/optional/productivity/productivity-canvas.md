...
| | |
|---|---|
| Source | Optional — install with `x19 skills install official/productivity/canvas` |
...
4. Name the token (e.g., "X19"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${X19_HOME:-~/.x19}/.env`:
