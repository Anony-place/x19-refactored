...
| | |
|---|---|
| Source | Optional — install with `x19 skills install official/productivity/property-listings` |
...
Present researched properties as browsable cards in the X19 desktop transcript.
...
- An X19 desktop conversation for native cards; the backend may be local or remote.
...
```text
x19 skills install official/productivity/property-listings
```
