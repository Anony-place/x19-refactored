...
| | |
|---|---|
| Source | Optional — install with `x19 skills install official/research/gitnexus-explorer` |
...
| Related skills | [`x19`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-x19), [`codebase-inspection`](/docs/user-guide/skills/bundled/software-development/software-development-codebase-inspection) |
