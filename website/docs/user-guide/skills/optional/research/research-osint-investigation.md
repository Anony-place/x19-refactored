...
| | |
|---|---|
| Source | Optional — install with `x19 skills install official/research/osint-investigation` |
| Path | `optional-skills/research\osint-investigation` |
| Version | `0.1.0` |
| Author | X19 (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $X19_OSINT_CACHE/icij/ (default: ~/.cache/x19-osint/icij/).
...
# Set X19_OSINT_UA=your-app/1.0 (your@email) to identify yourself
