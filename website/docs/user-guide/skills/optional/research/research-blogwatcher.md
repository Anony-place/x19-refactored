...
| | |
|---|---|
| Source | Optional — install with `x19 skills install official/research/blogwatcher` |
...
## Working with X19 tools (read this first)

`blogwatcher-cli` is the feed database; X19 tools do the automation around it:
