...
| | |
|---|---|
| Source | Optional — install with `x19 skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`x19`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-x19), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
X19 via the native MCP client. This is the preferred
...
Then configure X19 to connect via HTTP:
