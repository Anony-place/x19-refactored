...
| | |
|---|---|
| Source | Optional — install with `x19 skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research\darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), X19 |
| License | MIT |
...
import upstream classes into X19 itself.
...
Open `~/.x19/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside X19 core.
   Custom driver scripts under `~/.x19/skills/...` are user-side and fine.
