...
- `{"question":"Do you want to copy the OpenClaw workspace instructions file into a X19 workspace?","choices":["skip workspace instructions","copy to a workspace path","decide later"]}`
