...
| | |
|---|---|
| Source | Optional — install with `x19 skills install official/web-development/page-agent` |
...
- User wants **X19 itself to drive a browser** → use X19' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
