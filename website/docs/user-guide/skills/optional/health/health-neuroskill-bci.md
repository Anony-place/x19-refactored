...
| | |
|---|---|
| Source | Optional — install with `x19 skills install official/health/neuroskill-bci` |
...
Connect X19 to a running [NeuroSkill](https://neuroskill.com/) instance to read
