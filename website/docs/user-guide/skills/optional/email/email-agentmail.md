...
| | |
|---|---|
| Source | Optional — install with `x19 skills install official/email/agentmail` |
...
No API key yet? Use [signup.md](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/email\agentmail/references/signup.md).
...
- [signup.md](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/email\agentmail/references/signup.md): self-signup and OTP verification.
- [core.md](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/email\agentmail/references/core.md): inboxes, messages, threads, labels, attachments.
- [webhooks.md](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/email\agentmail/references/webhooks.md): events to a public HTTPS server.
- [websockets.md](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/email\agentmail/references/websockets.md): events to a local agent process.
- [mcp.md](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/email\agentmail/references/mcp.md): MCP integration.

## Procedure

1. Install `agentmail-cli@latest` and verify `agentmail inboxes list --format json`.
2. If no API key is available, complete [signup.md](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/email\agentmail/references/signup.md).
3. Use [core.md](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/email\agentmail/references/core.md) for inbox, send, read, reply, forward,
   label, thread, and attachment flows.
4. Add [webhooks.md](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/email\agentmail/references/webhooks.md) or
   [websockets.md](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/email\agentmail/references/websockets.md) only when polling is not enough.
