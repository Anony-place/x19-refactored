...
| | |
|---|---|
| Source | Optional — install with `x19 skills install official/creative/audiocraft-audio-generation` |
...
- **[Advanced Usage](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/creative\audiocraft-audio-generation/references/advanced-usage.md)** - Training, fine-tuning, deployment
- **[Troubleshooting](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/creative\audiocraft-audio-generation/references/troubleshooting.md)** - Common issues and solutions
