...
| | |
|---|---|
| Source | Optional — install with `x19 skills install official/mlops/lambda-labs` |
...
- **[Advanced Usage](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/mlops\lambda-labs/references/advanced-usage.md)** - Multi-node training, API automation
- **[Troubleshooting](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/mlops\lambda-labs/references/troubleshooting.md)** - Common issues and solutions
