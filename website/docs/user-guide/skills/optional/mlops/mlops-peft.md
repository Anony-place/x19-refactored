...
| | |
|---|---|
| Source | Optional — install with `x19 skills install official/mlops/peft` |
...
- **[Advanced Usage](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/mlops\peft/references/advanced-usage.md)** - DoRA, LoftQ, rank stabilization, custom modules
- **[Troubleshooting](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/mlops\peft/references/troubleshooting.md)** - Common errors, debugging, optimization
