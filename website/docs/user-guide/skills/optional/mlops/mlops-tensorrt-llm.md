...
| | |
|---|---|
| Source | Optional — install with `x19 skills install official/mlops/tensorrt-llm` |
...
- **[Optimization Guide](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/mlops\tensorrt-llm/references/optimization.md)** - Quantization, batching, KV cache tuning
- **[Multi-GPU Setup](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/mlops\tensorrt-llm/references/multi-gpu.md)** - Tensor/pipeline parallelism, multi-node
- **[Serving Guide](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/mlops\tensorrt-llm/references/serving.md)** - Production deployment, monitoring, autoscaling
