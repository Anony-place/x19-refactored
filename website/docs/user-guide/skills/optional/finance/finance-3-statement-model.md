...
| | |
|---|---|
| Source | Optional — install with `x19 skills install official/finance/3-statement-model` |
...
See [references/formulas.md](https://github.com/Anony-place/x19-refactored/blob/main/optional-skills/finance\3-statement-model/references/formulas.md) for all formula details.
