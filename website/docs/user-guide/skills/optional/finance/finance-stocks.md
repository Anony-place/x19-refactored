...
| | |
|---|---|
| Source | Optional — install with `x19 skills install official/finance/stocks` |
| Path | `optional-skills/finance\stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), X19 |
| License | MIT |
...
```
python ~/.x19/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
