...
Set your Tenor API key in your environment (add to `${X19_HOME:-~/.x19}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/Anony-place/x19-refactored/blob/main/skills/media\gif-search/url)`
