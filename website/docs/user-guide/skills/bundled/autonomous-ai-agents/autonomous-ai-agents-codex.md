...
| Related skills | [`claude-code`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`x19`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-x19) |
...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the X19 terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For X19 itself, `model.provider: openai-codex` uses X19-managed Codex
OAuth from `~/.x19/auth.json` after `x19 auth add openai-codex`. For the
