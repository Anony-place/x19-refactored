...
const config: Config = {
  ...
  url: 'https://anony-place.github.io/x19-refactored',
  baseUrl: '/docs/',
      ...
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          },
          {
            ...
            from: '/guides/build-a-x19-plugin',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/Anony-place/x19-refactored/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://anony-place.github.io/x19-refactored/',
          label: 'Download',
          position: 'left',
        },
        {
        ...
        {
          href: 'https://github.com/Anony-place/x19-refactored',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/Anony-place/x19-refactored/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://anony-place.github.io/x19-refactored/' },
            { label: 'GitHub', href: 'https://github.com/Anony-place/x19-refactored' },
