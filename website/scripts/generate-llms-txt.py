#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the X19 docs site.
...
LLM reads to learn what X19 does.

Both publish at:
  https://anony-place.github.io/x19-refactored/docs/llms.txt
  https://anony-place.github.io/x19-refactored/docs/llms-full.txt
...
SITE_BASE = "https://anony-place.github.io/x19-refactored/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use X19 as a Python Library", None),
        ("guides/use-mcp-with-x19", "Use MCP with X19", None),
        ("guides/use-voice-mode-with-x19", "Use Voice Mode with X19", None),
        ("guides/use-soul-with-x19", "Use SOUL.md with X19", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with X19"),
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/Anony-place/"
        "x19-refactored/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/Anony-place/x19-refactored")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# X19 — Full Documentation\n",
        (
            "This file is the entire X19 documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using X19, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://anony-place.github.io/x19-refactored/docs\n",
        "Short index: https://anony-place.github.io/x19-refactored/docs/llms.txt\n",
        "\n---\n\n",
    ]
