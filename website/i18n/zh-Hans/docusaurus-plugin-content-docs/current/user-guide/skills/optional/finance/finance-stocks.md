...
| | |
|---|---|
| 来源 | 可选 — 使用 `x19 skills install official/finance/stocks` 安装 |
...
```
SCRIPT=~/.x19/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.x19/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
