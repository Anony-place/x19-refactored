  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the X19 community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use X19 &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with X19?{' '}
        <a
          href="https://github.com/Anony-place/x19-refactored/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
