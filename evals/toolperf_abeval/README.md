...
batch (tracker: [#77056](https://github.com/Anony-place/x19-refactored/issues/77056)).
...
- **Two arms, one variable.** `baseline` and `fixes` runs differ ONLY by
  ...
  X19 home, same model, same tasks, same reps.
...
1. Create a dedicated X19 home with credentials for the models under test:
   ...
   integration at it; no X19 observability plugin needs to be enabled.
