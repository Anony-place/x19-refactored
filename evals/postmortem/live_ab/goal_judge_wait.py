...
os.environ.setdefault("X19_HOME", os.path.expanduser("~/.x19"))  # LIVE: real auxiliary judge calls (cents)
from x19_cli import goals
goal = ("Simplify the x19 codebase by >=30% LOC with zero behavior change, decomposing every god file, "
