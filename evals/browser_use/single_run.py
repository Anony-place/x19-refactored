...
The run gets a throwaway X19_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE X19_HOME is redirected to the
