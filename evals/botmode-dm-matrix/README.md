...
Scratch HOME, X19_HOME, Python facade and CLI shims; no user profiles or credentials.
...
(cd apps/desktop && X19_DESKTOP_CDP_PORT=off BOT_DM_SERVICE_PATH=1 \
...
worktree-pinned `x19`; PATH contains a different inert `x19` that exits 2
