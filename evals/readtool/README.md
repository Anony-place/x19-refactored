...
benchmarked ten harnesses on hostile-file handling — and whose X19 column
...
Every task runs the full X19 (file + terminal + search toolsets)
...
Rules of engagement (from x19bench discipline):
