...
os.environ["X19_HOME"] = str(root / ".x19")
from x19_cli import update_cmd_fleet as fleet, update_receipt as receipts
...
try:
    ...
    d = root / ".x19/logs/update_receipts"
