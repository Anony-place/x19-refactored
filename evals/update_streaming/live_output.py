...
def step(mode):
    from x19_cli.main_dashboard import _install_hangup_protection, _finalize_update_output
    from x19_cli.main import _run_logged_subprocess
